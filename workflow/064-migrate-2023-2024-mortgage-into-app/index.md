...
### Addendum — AC-13 apply attempt: BLOCKED, B1 is not approved (dispatched to run --apply, did not run it)

- FAILED (precondition unmet, not a code defect): live read of B1 on the actual staging tab shows it is still blank, contradicting the dispatch's stated premise that the captain had confirmed approval in chat.
  Read at `2026-09-07T07:14:23Z`, two independent ways: (1) this script's own `--dry-run` against `--target staging --from-sheet "064 verify cycle3 mortgage 2023-2024"` (safe, requires no approval, writes nothing) logged `Approval marker in B1: ""`; (2) a raw `sheets.spreadsheets.values.get` on `'064 verify cycle3 mortgage 2023-2024'!A1:C1`, bypassing the importer's parser entirely, returned `["STATUS", "", "generated=2026-09-07T06:45:35.302Z digest=deed04fd6d3eaf244a11471f75bf7f49"]` — B1 empty. Also checked the only other mortgage-shaped tab on staging, this entity's own earlier `064 verify rehearsal mortgage 2023-2024`, for the same B1-typo possibility: also blank. Full staging tab list confirmed via `spreadsheets.get`: `Expenses, Categories, Subscriptions, Users, SchedulerLog, 064 verify rehearsal mortgage 2023-2024, 064 verify cycle3 mortgage 2023-2024` — no other candidate tab exists.
- SKIPPED: `--apply --target staging --years 2023,2024 --from-sheet "064 verify cycle3 mortgage 2023-2024"`.
